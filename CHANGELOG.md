...
### Fixed
- Menu buttons: Fixed an issue where Set Channel and Back buttons were not appearing in some Telegram clients by switching to HTML parse mode and adding an explicit start command.
